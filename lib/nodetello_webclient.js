...
var nodetello_webclient = function () {
	...
	this.h264encoder_spawn = {
			"command" : 'ffmpeg',
			//"args"    : [ '-fflags', 'nobuffer', '-f', 'h264', '-i', "-", '-c:v', 'libx264', '-b:v', '1M', '-profile', 'baseline', '-preset', 'ultrafast', '-pass', '1', '-coder', '0', '-bf', '0', '-flags', '-loop', '-wpredp', '0', '-an', '-f', 'h264', '-']
			"args"    : [ '-f', 'h264', '-i', "-", '-r', '35', '-c:v', 'libx264', '-b:v', '1M', '-profile', 'baseline', '-preset', 'ultrafast', '-an', '-f', 'h264', '-']
		};
